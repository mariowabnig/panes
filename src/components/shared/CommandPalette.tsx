...
export function CommandPalette({ open, onClose }: Props) {
  ...
  const commandCtx = useMemo<CommandContext>(
    ...
    [activeWorkspaceId, activeRepoPath, activeGitRepos, animatedClose],
  );
  ...
  const executeItem = useCallback(
    ...
    [commandCtx, activeWorkspaceRootPath, activeWorkspaceId, activeThreadId, animatedClose, launchHarness, openMessageResult, subFlow, t, pendingCommandId, availableCommands, activeGitRepos.length, resolveRepoStatus],
  );
  ...
  }, [subFlow, effectiveRepoPath, animatedClose, flatItems, activeIndex, executeItem, t, resolveRepoStatus]);
  ...
  const onKeyDown = useCallback(
    ...
    [flatItems, activeIndex, subFlow, query, animatedClose, executeItem, executeSubFlow, mode, term, scopedRepo, pendingCommandId],
  );
